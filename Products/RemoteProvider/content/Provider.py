...
schema = Schema((
    ...
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            description=_(u'remoteprovider_title_description',
                default=u"The Title of the Organisation as it should show up "
    ...
    TextField(
        name='description',
        widget=RichWidget(
            label=_(u'remoteprovider_description_label',
                    default=u"Description"),
            description=_(u'remoteprovider_description_description',
                default=u"A short descriptive text which describes this "
                        u"provider."),
            rows=5,
        ),
        schemata="default",
    ...
    StringField(
        ...
        widget=StringField._properties['widget'](
            macro="urlwidget",
            label=_(u'remoteprovider_remoteUrl_label',
                    default=u"Web Address (URL)"),
            description=_(u'remoteprovider_remoteUrl_description',
                default=u"The web address where you can reach the providers "
                        u"homepage."),
        ),
        searchable=True,
    ),
    StringField(
        ...
        widget=SelectionWidget(
            label=_(u'remoteprovider_providerCategory_label',
                    default=u"Provider Category"),
            description=_(u'remoteprovider_providerCategory_description',
                default=u"Specify the category this provider belongs to"),
    ...
    StringField(
        name='contact_name',
        widget=StringField._properties['widget'](
            label=_(u'remoteprovider_contact_name_label',
                    default=u"Contact Name"),
            description=_(u'remoteprovider_contact_name_description',
                default=u"The name of the person which people can contact."),
        ),
        schemata="Contact",
    ),
    LinesField(
        ...
        widget=LinesWidget(
            ...
            description=_(u'remoteprovider_address_description',
                          default=u"The contact persons postal address."),
        ),
    ...
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            description=_(u'remoteprovider_phone_description',
                          default=u"The contact persons phone number."),
        ),
        schemata="Contact",
    ),
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            description=_(u'remoteprovider_fax_description',
                          default=u"The contact persons fax number."),
        ),
        schemata="Contact",
    ),
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            description=_(u'remoteprovider_email_description',
                default=u"Contact this address for further information"),
            macro="emailwidget",
        ),
        schemata="Contact",
    ),
    StringField(
        name='contact_url',
        widget=StringField._properties['widget'](
            label=_(u'remoteprovider_contact_url_label',
                    default=u"Contact Url"),
            description=_(u'remoteprovider_contact_url_description',
                default=u"This URL can be used for contacting the provider."),
            macro="urlwidget",
        ),
        schemata="Contact",
    ),
    LinesField(
        ...
        widget=MultiSelectionWidget(
            label=_(u'remoteprovider_remoteLanguage_label',
                    u"Remote Language"),
            description=_(u'remoteprovider_remoteLanguage_description',
...
class Provider(BaseContent, BrowserDefaultMixin):
    ...
    def getProviderDefault(self):
        ...
        provider = (portal.getProperty('provider', None)
            or portal.portal_properties.site_properties.getProperty(
                'provider', None)
            or DEFAULT_PROVIDER)
        return provider
